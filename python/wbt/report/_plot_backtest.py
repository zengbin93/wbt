...
供 wbt.report.generate_backtest_report 内部使用；如果需要独立的绘图函数，
请参考 wbt.plotting 模块下经过调整的简化版本。
"""
...
def _figure_to_html(fig: go.Figure, to_html: bool = False, include_plotlyjs: bool = True) -> go.Figure | str:
