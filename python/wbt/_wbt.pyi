...
def _normalize_returns(returns: list[float], yearly_days: int, target_vol: float) -> list[float] | None: ...
def _vol_adjusted_alpha(
    long: list[float], bench: list[float], yearly_days: int, target_vol: float
) -> list[float] | None: ...
