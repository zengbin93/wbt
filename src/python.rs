...
impl PyWeightBacktest {
    ...
    #[pyo3(signature = (mode="history", target_vol=0.20, max_dd_threshold=0.20, max_alpha_dd_threshold=0.30, min_full_sharpe=0.5, min_year_days=200, recent_days=252, min_history_days=60))]
